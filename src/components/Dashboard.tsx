  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto text-gray-900 dark:text-gray-100">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 dark:border-neutral-800 pb-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 px-3.5 py-2 text-xs font-semibold text-[#184528] dark:text-emerald-300 bg-transparent border border-[#184528] dark:border-emerald-500/50 rounded-xl hover:bg-[#e8f0eb] dark:hover:bg-[#184528]/30 transition-colors shadow-xs"
          >
            Manage Directory
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold text-white bg-[#184528] hover:bg-[#12331b] active:bg-[#0c2212] rounded-xl transition-all shadow-xs border border-[#184528] focus:outline-none focus:ring-2 focus:ring-[#184528]"
          >
      ...
      <div className="bg-white dark:bg-black rounded-2xl border border-gray-200 dark:border-neutral-800 shadow-xs overflow-hidden">
        {/* Table Controls */}
        <div className="p-5 border-b border-gray-200 dark:border-neutral-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gray-50/50 dark:bg-black">
          <div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {/* Filter Pills */}
            <div className="flex items-center p-1 bg-gray-100 dark:bg-black rounded-xl border border-gray-200 dark:border-neutral-800 text-xs font-medium text-gray-600 dark:text-gray-300">
